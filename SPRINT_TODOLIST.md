...
| ~~[#67](https://github.com/larry610881/agentic-rag-customer-service/issues/67)~~ | ~~認證面加固 P1：register 角色授權、/auth/token 限 development、providers/mcp-servers 掛認證~~ | ~~`bug`~~ | ~~3d-711 session 紅隊檢視（4 Critical + 1 High）~~ ✅ 2026-09-03 |
