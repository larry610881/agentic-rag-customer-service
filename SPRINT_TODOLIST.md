...
| [#74](https://github.com/larry610881/agentic-rag-customer-service/issues/74) | 雙軌計價：方案可選 token 制（預設）或點數制（月費 / 月點數 / 類別倍率 / 模型點數），token 仍為事實來源；依賴 #73 | `enhancement` | 2026-09-07 Larry 定案；三支 migration 待授權 |
