...
| [#67](https://github.com/larry610881/agentic-rag-customer-service/issues/67) | 認證面加固 P1–P5：register 邀請制、providers/mcp/workers 認證、租戶 API key（client_credentials）、JWT 改版（旋轉/撤銷）、widget 短效票、app_env 預設 production | `bug` | 3d-711 session 紅隊檢視；程式碼全部完成 2026-09-03，**待 migration 授權（add_api_keys / add_users_token_version）+ POC 部署驗證** |
