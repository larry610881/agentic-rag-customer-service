...
| [#73](https://github.com/larry610881/agentic-rag-customer-service/issues/73) | 用量記帳缺口：embedding 從未入帳（Cached/Dynamic 包裝沒轉發 token）、reprocess 管線全未記、查詢 embedding 未記、bot_id 歸屬遺失、字元數當 token、死類別；點數制前置 | `bug` | 2026-09-07 全路徑盤點開；建議最先做 |
