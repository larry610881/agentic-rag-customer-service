...
| [#75](https://github.com/larry610881/agentic-rag-customer-service/issues/75) | 防護階段三層設定（系統底線 / 方案 / 租戶 bot 自選）+ 鎖定 + 全稽核；kb 模式攻擊判定開關 | `enhancement` | 2026-09-07 Larry 定案：系統管底線、租戶只能加嚴、誰改都稽核 |
