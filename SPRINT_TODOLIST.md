...
| [#78](https://github.com/larry610881/agentic-rag-customer-service/issues/78) | OCR 多供應商：Gemini（OpenAI 相容視覺）OCR 引擎 + 依 KB.ocr_model / 租戶預設動態選引擎（現況只有 Claude 單例、KB.ocr_model 未生效） | `enhancement` | 2026-09-07 開；Larry 重建家樂福不用 Claude token；排 #73 之後、#74 之前 |
