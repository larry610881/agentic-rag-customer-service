...
| [#79](https://github.com/larry610881/agentic-rag-customer-service/issues/79) | 廠商商品專有名詞對應表（OCR 後確定性校正），取代 prompt 內寫死品牌字；初始字典可用家樂福 865 商品 JSON | `enhancement` | 2026-09-08 開；OCR 紀律已改通用「專有名詞保護」（無寫死字樣） |
