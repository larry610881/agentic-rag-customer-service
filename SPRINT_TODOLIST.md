...
| [#72](https://github.com/larry610881/agentic-rag-customer-service/issues/72) | 推理強度可關閉（none）+ web/widget/API 漏傳修正 + 各供應商 thinking 對應 + 審計/指紋/reasoning token；weekly-report session 轉派 | `enhancement` | 2026-09-04 開；gpt-5.1 預設 none → LINE 之前沒走 thinking；排 #70 之後 |
