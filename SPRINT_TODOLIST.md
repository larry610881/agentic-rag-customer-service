...
| [#60](https://github.com/larry610881/agentic-rag-customer-service/issues/60) | 執行時設定指紋（config_snapshots）+ 管理端 audit_logs | `enhancement` | 09-02 紅隊追溯需求 |
| [#61](https://github.com/larry610881/agentic-rag-customer-service/issues/61) | 快速道抽共用管線（web 覆蓋）+ Gemini 3.7 Flash low 驗證 | `refactor` | 09-02 快速/深度兩類 bot 定位 |
