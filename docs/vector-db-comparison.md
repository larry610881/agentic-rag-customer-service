...
> ⚠️ **歷史決策文件（2026-03-15）** — 本文當時在 pgvector vs Qdrant 之間做比較。
> **2026-04 專案已改採 Milvus**（非本文涵蓋的兩個選項之一）。
> 下文所有「Qdrant」的分析仍可作為「self-hosted 向量 DB」代表性案例參考，
> 但成本、指令、port 等數字需以 Milvus 實際配置為準。保留本文作為決策歷史紀錄。
