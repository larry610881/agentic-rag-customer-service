-- Platform Seed Data (MySQL format)
-- Exported from PostgreSQL on 2026-03-18, converted to MySQL syntax
...
VALUES ('ecfb9372-3043-4b25-a368-295bb7e39279', 'http://localhost:9000/mcp', '', 'http', 'http://localhost:9000/mcp', '', '[]', '[]', '[{"name": "search_products", "description": "商品查詢"}, {"name": "search_courses", "description": "課程查詢"}]', '', 'global', '[]', 1, '2026-03-17 01:14:41', '2026-03-17 01:14:41');
